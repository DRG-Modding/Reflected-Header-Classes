...
UDELEGATE() DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWebBrowserOnUrlChanged, const FText&, Text);
UDELEGATE() DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FWebBrowserOnBeforePopup, const FString&, URL, const FString&, Frame);
