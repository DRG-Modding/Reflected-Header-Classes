...
void UWeakpointGlowComponent::SetUpWeakPointGlowOnMeshByBone(const UMeshComponent*& Mesh, int32 MaterialIndex, FName Bone, UHealthComponentBase* HealthComponent) {
}
